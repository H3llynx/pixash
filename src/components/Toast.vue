...
const toastBox = tv({
    base: "flex px-0.5 py-1 gap-0.5 w-full max-w-xs items-start rounded-xl fixed z-3 bottom-4 left-1/2 -translate-x-1/2 border md:bottom-auto md:top-4 md:right-4 md:left-auto md:translate-x-0",
    variants: {
        type: {
