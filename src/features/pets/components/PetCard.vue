...
const handleDelete = async () => {
    if (!props.pet) return;
    open({
        title: t("dialog.deletePet.title", { name: props.pet.name }),
        ...
        <div class="flex items-center gap-1">
            ...
            <div class="w-full">
                <div class="flex gap-0.5 items-center">
                    ...
                    <Button action="delete" :aria-label="t('pet.cta.delete', { name: pet.name })"
                        @click="handleDelete" />
                </div>
                ...
                <div class="flex gap-0.5">
                    <span class="tag capitalize bg-green-rgba text-green" v-if="pet.sterilized">{{ pet.sex ===
                        "male" ?
